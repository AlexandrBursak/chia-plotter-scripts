...
plot_size_5=85195312
plot_size_7=81816406

merge=plot_size_5-plot_size_7
...
def get_total_space_use(disk_size, count_of_bigger, count_of_less):
	total_space_use = count_of_bigger * plot_size_5 + count_of_less * plot_size_7

	if disk_size-total_space_use > plot_size_7:
...
for size in disk_sizes:
	...
	count_of_bigger = math.floor(disk_size/plot_size_5)
	total_use = count_of_bigger * plot_size_5
	...
	validate_size = count_of_bigger * plot_size_5 + count_of_less * plot_size_7
	...
	if validate_size > disk_size:
		...
		print('For', size, 'C5:', count_of_bigger, 'C7:', count_of_less)
	print('======= Cycle end =======')
